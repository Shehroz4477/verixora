// ====================================================================
// VERIXORA – Identity.Domain / Events / UserEmailVerified.cs
// ====================================================================
//
// ARCHITECTURAL ROLE:
//   A domain event raised when a user verifies their email address.
//   Handlers in the Application layer react to this event to:
//     - Enable full access for the user (they can now log in).
