// ====================================================================
// VERIXORA – Identity.Domain / Events / UserSessionCreated.cs
// ====================================================================
//
// ARCHITECTURAL ROLE:
//   A domain event raised when a new session is created for a user
//   (i.e., the user logs in).  Handlers in the Application layer
//   react to this event to:
...
/// <summary>
/// Raised when a new session is created for a user.
/// </summary>
public sealed record UserSessionCreated(
    Ulid UserId,
