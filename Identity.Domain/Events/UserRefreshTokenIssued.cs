// ====================================================================
// VERIXORA – Identity.Domain / Events / UserRefreshTokenIssued.cs
// ====================================================================
//
// ARCHITECTURAL ROLE:
//   A domain event raised when a new refresh token is issued to a
//   user.  Handlers in the Application layer react to this event to:
//     - Update the audit log.
//     - Track token issuance for security monitoring.
//
//   WHY A DOMAIN EVENT:
...
/// <summary>
/// Raised when a new refresh token is issued to a user.
/// </summary>
public sealed record UserRefreshTokenIssued(
    Ulid UserId,
