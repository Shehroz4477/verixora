// ====================================================================
// VERIXORA – Identity.Domain / Events / UserPasswordChanged.cs
// ====================================================================
//
// ARCHITECTURAL ROLE:
//   A domain event raised when a user changes their password.
//   Handlers in the Application layer react to this event to:
//     - Revoke all existing refresh tokens for the user (forcing
//       re‑authentication on all devices).
//     - Revoke all existing sessions (forcing logout everywhere).
//     - Send a security notification to the user.
//     - Update the audit log.
//
//   SECURITY:
//     This event is critical for security.  After a password
//     change, all existing credentials (sessions, refresh tokens)
//     should be invalidated to prevent a compromised account from
